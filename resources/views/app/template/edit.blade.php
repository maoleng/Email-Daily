...
@section('content')
    <form action="{{route('template.update', ['template' => $template])}}" id="form" method="post" class="intro-y col-span-12 lg:col-span-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                ...
                <div>
                    ...
                    <input id="crud-form-1" type="text" name="title" value="{{$template->title}}" class="form-control form-control-rounded w-full" placeholder="Tiêu đề của mail">
                </div>
                <div class="mt-3">
                    <label for="crud-form-1" class="form-label">Tên người gửi</label>
                    <input id="crud-form-1" type="text" name="sender" value="{{$template->sender}}" class="form-control form-control-rounded w-full" placeholder="Tên của người sẽ gửi mail cho bạn">
                </div>
                <div class="mt-3">
                    <label>Nội dung của mail</label>
                    <div class="mt-2">
                        <textarea name="content" id="myeditorinstance">{{$template->content}}</textarea>
                    </div>
                </div>
...
{{--            </div>--}}
{{--            <form data-single="true" action="/test123" class="dropzone" method="post" enctype="multipart/form-data">--}}
{{--                @csrf--}}
{{--                <div class="fallback">--}}
